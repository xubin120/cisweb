				...
				<div class="am-u-md-6 am-cf">
					<div class="am-btn-toolbar am-fl am-cf">
						<div class="am-btn-group am-btn-group-xs">
							<button type="button" class="am-btn am-btn-default btn-click" onclick="location.href='preAddCustomer'">
					...
					<table class="am-table am-table-striped am-table-hover table-main">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<c:if test="${customer.customerType=='1'}">会员客户</c:if>
									<c:if test="${customer.customerType=='2'}">潜在客户</c:if>
								</td>
								<td><s:property value="birthday"/></td>
								<td><s:property value="membershipDate"/></td>
								<td>
									<div class="am-btn-toolbar">
										<div class="am-btn-group am-btn-group-xs">
											<button type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary btn-click" onclick="location.href='<s:url action="preEditCustomer"><s:param name="customerId" value="id" /></s:url>'">
												<span class="am-icon-pencil-square-o"></span> 编辑
											</button>
											<button type="button" class="am-btn am-btn-default am-btn-xs am-text-danger btn-click" onclick="location.href='<s:url action="deleteCustomer"><s:param name="customerId" value="id" /></s:url>'">
												<span class="am-icon-trash-o"></span> 删除
											</button>
										</div>
									</div>
