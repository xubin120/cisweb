		...
		<div class="admin-content">
			<div class="am-cf am-padding">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">项目管理</strong> / <small>新增项目</small>
				</div>
			</div>
			...
			<div class="am-u-sm-12">
		    	<form id="fm1" class="am-form am-form-horizontal" action="addItem" method="post">
					<div class="am-g am-form-group">
						...
						<div class="am-u-sm-3">
							<input type="text" class="am-form-field am-input-sm" id="item-name" name="itemVO.name" placeholder="请输入项目名称" required maxlength="50" tabindex="1">
						</div>
						...
						<div class="am-u-sm-3">
							<input type="text" class="am-form-field am-input-sm" id="item-price" name="itemVO.price" placeholder="请输入项目价格" required maxlength="10">
						</div>
						<label class="am-u-sm-1 am-form-label" style="color: red">* 必填</label>
					</div>
						...
						<label for="item-description" class="am-u-sm-2 am-form-label">项目描述</label>
			          	<div class="am-u-sm-3">
			            	<textarea rows="4" cols="" class="am-form-field am-input-sm" id="item-description" 
									name="itemVO.description" placeholder="请输入项目描述" maxlength="50" required></textarea>
			          	</div>
			          	<label class="am-u-sm-1 am-form-label" style="color: red">* 必填</label>
