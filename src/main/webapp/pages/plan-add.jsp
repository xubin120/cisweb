		...
		<div class="admin-content">
			<div class="am-cf am-padding">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">方案管理</strong> / <small>新增方案</small>
				</div>
			</div>
			...
			<div class="am-u-sm-12">
		    	<form id="fm1" class="am-form am-form-horizontal" action="addPlan" method="post">
					...
					<div class="am-g am-form-group">
						...
						<div class="am-u-sm-3">
							<input type="text" class="am-form-field am-input-sm" id="plan-name" name="planVO.name" placeholder="请输入方案名称" required maxlength="20" tabindex="1">
						</div>
						...
						<div class="am-u-sm-3">
							<input type="text" class="am-form-field am-input-sm" id="plan-price" name="planVO.price" placeholder="请输入方案价格" maxlength="10">
						</div>
