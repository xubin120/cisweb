	...
	<div class="am-cf admin-main">
		...
		<div class="admin-content">
			...
			<div class="am-u-sm-12">
		    	<form id="fm1" class="am-form am-form-horizontal" action="editActivity" method="post" data-am-validator>
		    	<fieldset>
						...
						<label for="activity-startDate" class="am-u-sm-2 am-form-label">活动开始日期</label>
			          	<div class="am-u-sm-3">
			          		<div class="am-input-group am-form-icon date" id="datetimepicker-startDate" >
								...
								<input type="text" class="am-form-field am-input-sm" name="activityVO.startDate" 
									placeholder="请选择活动开始日期" value="${activityVO.startDate}" required readonly>
							</div>
			          	</div>
			          	...
			          	<div class="am-u-sm-3">
			            	<div class="am-input-group am-form-icon date" id="datetimepicker-endDate" >
								<span class="am-input-group-label add-on"><i class="icon-th am-icon-calendar"></i></span>
								<input type="text" class="am-form-field am-input-sm" name="activityVO.endDate" 
									placeholder="请选择活动结束日期" value="${activityVO.endDate}" required readonly>
							</div>
			          	</div>
			          	<label class="am-u-sm-1 am-form-label" style="color: red">* 必选</label>
			        </div>
