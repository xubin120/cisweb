				...
				<div class="am-u-md-6 am-cf">
					<div class="am-btn-toolbar am-fl am-cf">
						<div class="am-btn-group am-btn-group-xs">
							<button type="button" class="am-btn am-btn-default btn-click" onclick="location.href='preAdd'">
					...
					<table class="am-table am-table-striped am-table-hover table-main">
						<thead>
							<tr>
								...
								<th >邮箱</th>
								<th width="50px">状态</th>
								<th width="120px">入职日期</th>
								<th width="120px">离职日期</th>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<c:if test="${employee.status=='2'}">离职</c:if>
								</td>
								...
								<td>
									<div class="am-btn-toolbar">
										<div class="am-btn-group am-btn-group-xs">
											<button type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary btn-click" onclick="location.href='<s:url action="preEdit"><s:param name="employeeId" value="id" /></s:url>'">
												<span class="am-icon-pencil-square-o"></span> 编辑
											</button>
											<button type="button" class="am-btn am-btn-default am-btn-xs am-text-danger btn-click" onclick="location.href='<s:url action="delete"><s:param name="employeeId" value="id" /></s:url>'">
												<span class="am-icon-trash-o"></span> 删除
											</button>
										</div>
									</div>
						...
						<div class="am-fr">
							<ul class="am-pagination">
								<li class="<c:if test="${pi.hasPreviousPage=='false'}">am-disabled</c:if>"> 
									<a href="findAllEmployee?currentPage=${pi.firstPage}">首页</a>
								</li>
								...
								<li class="<c:if test="${pi.hasNextPage=='false'}">am-disabled</c:if>">
									<a href="findAllEmployee?currentPage=${pi.lastPage}">尾页</a>
								</li>
							</ul>
						</div>
					</div>
