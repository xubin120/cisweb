	...
	<div class="am-cf admin-main">
		...
		<div class="admin-content">
			...
			<div class="am-tabs am-margin" data-am-tabs>
		    	...
		    	<form id="fm1" class="am-form am-form-horizontal" action="editCustomer" method="post" data-am-validator>
							...
							<div class="am-tab-panel am-fade am-in am-active" id="tab1">
								<div class="am-u-sm-12">
									<div class="am-g am-form-group">
										...
										<div class="am-u-sm-3">
											<input type="text" class="am-form-field am-input-sm" id="customer-age" name="customerVO.age" placeholder="请输入年龄" value="${customerVO.age}" maxlength="2" >
										</div>
										<label class="am-u-sm-1 am-form-label">&nbsp;</label>
									</div>
							          	...
							          	<div class="am-u-sm-3">
								            <div class="am-form-group" id="customer-sex">
								            	<label class="am-radio am-radio-inline">
								                	<input type="radio" name="customerVO.sex" id="customerMan" value="1" <s:if test='%{customerVO.sex == 1}'>checked</s:if>/> 男
								              	</label>
								              	<label class="am-radio am-radio-inline">
								                	<input type="radio" name="customerVO.sex" id="customerWoman" value="2" <s:if test="%{customerVO.sex == 2}">checked</s:if>/> 女
								              	</label>
								            </div>
							          	</div>
							          	<label class="am-u-sm-1 am-form-label">&nbsp;</label>
									...
									<div class="am-g am-form-group">
										...
										<div class="am-u-sm-3">
								            <div class="am-form-group" id="customer-customerType">
								            	<label class="am-radio am-radio-inline">
								                	<input type="radio" name="customerVO.customerType" id="ctMember" value="1" <s:if test='%{customerVO.customerType == 1}'>checked</s:if>/> 会员客户
								              	</label>
								              	<label class="am-radio am-radio-inline">
								                	<input type="radio" name="customerVO.customerType" id="ctPotential" value="2" <s:if test='%{customerVO.customerType == 2}'>checked</s:if>/> 潜在客户
								              	</label>
								            </div>
							          	</div>
										<label class="am-u-sm-1 am-form-label">&nbsp;</label>
									...
									<div class="am-g am-form-group">
										<label for="customer-birthday" class="am-u-sm-2 am-form-label">生日</label>
										<div class="am-u-sm-3">
											<div class="am-input-group am-form-icon date" id="datetimepicker-birthday" >
												<span class="am-input-group-label add-on"><i class="icon-th am-icon-calendar"></i></span>
												<input type="text" class="am-form-field am-input-sm" name="customerVO.birthday" placeholder="请选择生日" readonly value="${customerVO.birthday}">
											</div>
										</div>
										<label class="am-u-sm-1 am-form-label">&nbsp;</label>
										...
										<div class="am-u-sm-3">
											<div class="am-input-group am-form-icon date" id="datetimepicker-membershipDate" >
												<span class="am-input-group-label add-on"><i class="icon-th am-icon-calendar"></i></span>
												<input type="text" class="am-form-field am-input-sm" name="customerVO.membershipDate" placeholder="请选择入会日期" readonly value="${customerVO.membershipDate}">
											</div>
										</div>
										<label class="am-u-sm-1 am-form-label">&nbsp;</label>
									</div>
							...
							<div class="am-tab-panel am-fade" id="tab2">
								<div class="am-u-sm-12">
									<div class="am-g am-form-group">
										...
										<div class="am-u-sm-3">
											<div class="am-form-group" id="customerInfo-childrenSex">
								            	<label class="am-radio am-radio-inline">
								                	<input type="radio" name="customerVO.customerInfo.childrenSex" id="boy" value="1" <s:if test='%{customerVO.customerInfo.childrenSex == 1}'>checked</s:if>/> 男
								              	</label>
								              	<label class="am-radio am-radio-inline">
								                	<input type="radio" name="customerVO.customerInfo.childrenSex" id="girl" value="2" <s:if test='%{customerVO.customerInfo.childrenSex == 2}'>checked</s:if>/> 女
								              	</label>
								            </div>
										</div>
										<label class="am-u-sm-1 am-form-label">&nbsp;</label>
